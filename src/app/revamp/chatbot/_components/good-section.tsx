...
export default function GoodSection() {
  ...
  return (
    <div className="grid grid-cols-12">
      <div
        id="landing"
        className="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 relative w-auto"
      >
      ...
      >
        <div className="h-screen w-full bg-gradient-to-b from-[#1F0B01] to-[#351110]">
                ...
                >
                  <div className="w-full">
                    <input
                      ...
                      className="w-full rounded-full border border-white/25 bg-black/25 px-4 py-4 text-white"
