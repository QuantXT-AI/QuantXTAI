        ...
        <div className="container relative mx-auto max-w-6xl px-4">
          ...
          <div className="w-full py-16">
            <div className="flex flex-col items-start">
              ...
              <h2
                className="mb-8 text-4xl font-medium leading-[1.2] text-white/75 [text-shadow:0px_0px_4px_#FFFFFF] sm:text-4xl lg:text-6xl md:text-6xl"
                data-aos="fade-up"
                data-aos-delay="1400"
              >
                THE FUSION OF AI
              ...
              <p
                className="text-whitse/50 max-w-[820px] text-sm font-normal text-white/50 sm:text-sm md:text-md lg:text-lg"
                data-aos="fade-up"
                data-aos-delay="1800"
              >
