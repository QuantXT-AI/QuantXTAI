...
export default function Section2() {
  ...
  const overlayRobot = (children: any) => isDesktop ? (<div className="bg-[url('/assets/components/overlay/overlay-robot.png')] bg-[length:120%_90rem] sm:bg-[length:120%_90rem] md:bg-[length:120%_80rem] lg:bg-[length:120%_76rem] bg-bottom bg-no-repeat opacity-90">{children}</div>) : children
                ...
                >
                  <div className="flex flex-col items-start">
                    ...
                    <p className="text-md mb-8 font-epilogue text-white/75 md:mb-16 md:text-lg">
                      Building on our experience with Nvidia;s Inception Program. we
                      refine AI integration and ecosystem optimization.
                    </p>
                    <Link
                      href="/"
