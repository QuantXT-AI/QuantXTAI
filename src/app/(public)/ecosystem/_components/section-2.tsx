...
export default function Section2() {
  ...
  const overlayRobot = (children: React.ReactNode) =>
    isDesktop ? (
      <div className="bg-[url('/assets/components/overlay/overlay-robot.png')] bg-[length:120%_90rem] bg-bottom bg-no-repeat opacity-90 sm:bg-[length:120%_90rem] md:bg-[length:120%_80rem] lg:bg-[length:120%_76rem]">
        {children}
      </div>
    ) : (
      children
