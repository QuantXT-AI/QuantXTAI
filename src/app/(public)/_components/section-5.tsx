          ...
          <div className="col-span-12 md:col-span-6">
            <div className="flex h-full items-center justify-center">
              <div data-aos="fade-right" data-aos-delay="400">
                <h2 className="mb-4 text-start font-medium text-5xl text-[#EFCEE3] leading-[1.2] [text-shadow:0px_0px_4px_#FFFFFF] md:text-6xl">
                  TOKENOMICS
                </h2>
                <p className="font-normal text-[#EFCEE3] text-sm md:text-base">
